...
namespace Meva\AI\Facades;

use Illuminate\Support\Facades\Facade;
use Meva\AI\IntelligenceManager;
 ...
 *
 * @method static \Meva\AI\EntityIntelligence for(\Illuminate\Database\Eloquent\Model $entity)
 * @method static \Meva\AI\Context\EntityContext contextFor(\Illuminate\Database\Eloquent\Model $entity)
 ...
 * @method static \Meva\AI\Agents\EntityAgent agent(string $agent, \Illuminate\Database\Eloquent\Model $entity, mixed ...$arguments)
 *
