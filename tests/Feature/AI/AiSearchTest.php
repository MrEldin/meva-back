...
use Meva\AI\Models\AiEmbedding;
use Meva\AI\Search\EntityVectorIndex;
use Meva\AI\Tools\EntitySearchTool;
...
it('refuses to search an entity that is not searchable', function () {
    new EntitySearchTool(Meva\Entities\Permission\Models\Permission::class);
