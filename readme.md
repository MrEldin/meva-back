...
```bash
git clone git@github.com:MrEldin/meva.git
cd meva
docker compose up
```
...
```php
class InvoiceDisputeAgent extends \Meva\AI\Agents\EntityAgent
{
...
Meva ships generators that scaffold a full entity — model, repository,
